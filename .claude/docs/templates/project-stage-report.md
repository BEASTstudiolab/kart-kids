...
- `/game-reverse-document [type] [path]` — [For which gap]
- `/game-architecture-decision` — [For which gap]
- `/game-sprint-plan` — [If production planning missing]
- `/game-milestone-review` — [If approaching deadline]
- `/game-onboard [role]` — [If new contributor joining]
...
*Generated by `/game-project-stage-detect` skill*
