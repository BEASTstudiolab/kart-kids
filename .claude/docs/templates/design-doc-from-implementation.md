...
- Run `/game-balance-check` on [specific aspect]
...
- [ ] **Balance pass**: Run `/game-balance-check` on progression curve
...
**Related Skills**:
- `/game-balance-check` — Validate formulas and progression
- `/game-architecture-decision` — Document technical decisions
- `/game-code-review` — Ensure code matches clarified design

---

*This document was generated by `/game-reverse-document design [path]`*
