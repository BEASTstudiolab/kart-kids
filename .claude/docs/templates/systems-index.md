...
- [ ] Design MVP-tier systems first (use `/game-design-system [system-name]`)
- [ ] Run `/game-design-review` on each completed GDD
- [ ] Run `/game-gate-check pre-production` when MVP systems are designed
- [ ] Prototype the highest-risk system early (`/game-prototype [system]`)
