...
- [ ] Fill in CLAUDE.md technology stack based on engine choice (`/game-setup-engine`)
- [ ] Create game pillars document (`/game-design-review` to validate)
- [ ] Decompose concept into systems (`/game-map-systems` — maps dependencies, assigns priorities, guides per-system GDD writing)
- [ ] Create first architecture decision record (`/game-architecture-decision`)
- [ ] Prototype core loop (`/game-prototype [core-mechanic]`)
- [ ] Validate core loop with playtest (`/game-playtest-report`)
- [ ] Plan first milestone (`/game-sprint-plan new`)
