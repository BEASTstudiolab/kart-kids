...
| `detect-gaps.sh` | SessionStart | Session begins | Detects fresh projects (suggests /game-start) and missing documentation when code/prototypes exist, suggests /game-reverse-document or /game-project-stage-detect |
